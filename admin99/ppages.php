...
<head>
  ...
  if(isset($_POST['submit'])){
    ...
    $sql = "UPDATE ppages SET `title` = '$title',`keywords` = '$keywords',`desp` = '$desp',`icon` = '$icon',`post` = '$post' WHERE `id` =$id";
...
<body class="stretched">
  ...
  <?php
           ...
           $rows =mysqli_query($con,"SELECT * FROM ppages where id=$id " ) or die(mysqli_error($con));
...
<div class="row" style="margin-right: 0px">
  ...
  <tbody>
    ...
    $rows =mysqli_query($con,"SELECT * FROM ppages ORDER BY id asc LIMIT 1000 " ) or die(mysqli_error($con));
