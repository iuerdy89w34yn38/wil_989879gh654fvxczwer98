			...
			<div class="slider-parallax-inner">
				<div id="rev_slider_579_1_wrapper" class="rev_slider_wrapper fullscreen-container" data-alias="default-slider" style="padding:0px;">
					...
					<div id="rev_slider_579_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.1.4">
						<ul>   <!-- SLIDE  -->
							<li class="dark" data-transition="fade" data-slotamount="1" data-masterspeed="1000" data-thumb="images/slider/rev/main/s1-thumb.jpg"  data-saveperformance="off"  data-title="Welcome to Wilcode">
								<!-- MAIN IMAGE -->
								...
								<img src="images/menu/nl.png" data-animate="pulse" data-delay="2000" class="slideimg" > 
								...
								data-endeasing="Power4.easeIn" style="z-index: 3; white-space: normal;"><br><br> Presenting the Codes of WilCode</div>
								...
								<br><br>The most Professional, Reliable and Budget-Friendly Solution for all kinds of Digtal and Technical Needs.</div>
								...
								data-endelementdelay="0.1"
								data-endspeed="1000"
								data-endeasing="Power4.easeIn" style="z-index: 3; white-space: nowrap;"><a href="#start" class="button button-border button-white button-light button-large button-rounded tright nomargin"><span>Start Tour</span> <i class="icon-angle-right"></i></a></div>
							...
							<li class="dark" data-transition="slideup" data-slotamount="1" data-masterspeed="1000" data-thumb="images/slider/rev/main/s2-thumb.jpg"  data-fstransition="fade" data-fsmasterspeed="1000" data-fsslotamount="7" data-saveperformance="off"  data-title="Unlimited Homepages">
								<!-- MAIN IMAGE -->
								<img src="images/bg/1.png"  alt="wilcode"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat">
								<!-- LAYERS -->
								<!-- LAYER NR. 2 -->
								...
								data-endelementdelay="0.1"
								data-endspeed="1000"
								data-endeasing="Power4.easeIn" style="z-index: 11; white-space: nowrap;">Need Design Ideas?</div>
								...
								data-height="none"
								data-endeasing="Power4.easeIn" style="z-index: 11; font-size: 36px;white-space: nowrap;">Featured Designs.</div>
								...
								data-height="none"
								data-endeasing="Power4.easeIn" style="z-index: 11; max-width: 550px; white-space: normal;">Develop the Business, Branding, Magazines, Photography, e-Commerce and Blogging Websites, Softwares and Promotional Designs...</div>
